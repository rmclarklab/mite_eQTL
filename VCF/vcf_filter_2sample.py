...
"""
This script is for filtering raw vcf file.
Variants passed our filter will be written into a new vcf file.
Filter conditions: MQ >= 40.0; SOR <= 3; QD >=2; two samples with different variant call.
Developed by Meiyuan Ji (meiyuan.ji@utah.edu) 
